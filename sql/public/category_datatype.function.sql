--
-- Name: category_datatype(public.categories); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.category_datatype(c public.categories) RETURNS public.epiphet
